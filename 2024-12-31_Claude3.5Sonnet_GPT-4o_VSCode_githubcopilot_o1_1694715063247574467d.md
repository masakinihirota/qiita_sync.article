...
※👇️サンプルです、これはNext.js、Tailwind CSS、TypeScript、Zod、Shadcn/ui、Supabase、Drizzle等のツールを使用した場合の設定です。
...
※ルールを多く書きすぎるとAIの生成に反映されない場合があります。使いやすい用に適度な量に編集をしてください。
プロジェクト単位でルールを作っておくのが良いと思います。
