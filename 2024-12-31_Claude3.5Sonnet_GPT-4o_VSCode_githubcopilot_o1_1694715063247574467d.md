...
GitHub Copilotの新機能で、GitHub Copilotに対するAIの振る舞いを細かく調整出来るようになりました。

👇️ このCursorの Rules for AI と全く同じことが出来ます。
...
命令間の空白は無視されるため、命令を1つの段落として記述したり、それぞれを改行したり、読みやすくするために空白行で区切ったりすることができます。
