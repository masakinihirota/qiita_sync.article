...
tags:    Gemini,GitHubCopilot,Perplexity,cursor,database.build
...
動作確認してみると、最低限の機能ながらしっかりとtodoアプリが出来上がりました。
...
👆これらのモデルは使えますが、バージョンの指定はできず、現在どのバージョンを使っているかは不明です。
...
Cursorはエディタ自体にAI機能を組み込み、ネイティブにAIを使えるので十二分に👇エディタ機能を生かせることが可能です。
