...
private: false
-->
【Next.js】middleware.jsでサーバーアクションを除外する方法 #Next.js - Qiita
https://qiita.com/P-man_Brown/items/5581ead6dbfc864957ef
...
Next.jsでは、規約で middleware.ts を1つだけ使えます。
(コード的に export、importは可能です。)
...
※現在 (バージョン Next.js 15 時点) ではRSC(リアクト サーバー コンポーネント)が実装されたので、console.logはブラウザ側にもサーバー側にも出力される可能性が出てきました。
