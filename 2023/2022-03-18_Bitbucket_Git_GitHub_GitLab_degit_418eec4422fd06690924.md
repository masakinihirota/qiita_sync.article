...
大型リポジトリの中の一部のコードやサンプルをダウンロードします。

例えば、Next.jsというフレームワークのGitHub大型リポジトリ **（約50000KB）** があります、その中にNext.js用の説明サンプルのコードもそのリポジトリ内に含まれています。

※hello-worldというサンプルなら ***（約2KB）***

そのサンプルのコードだけを**手元で見てみたい**場合などに便利です。

※Next.jsの場合は、直接サンプルのリポジトリ名を指定するだけで、その**サンプルをインストール**できます。
...
* **degit**
この記事で説明していたの元々のツールです・・・が、2021年から開発が止まっています。
