...
pnpm install --save-dev eslint-plugin-import eslint-plugin-unused-imports
...
pnpm install @storybook/testing-library @storybook/jest @storybook/addon-interactions --save-dev
...
pnpm install -D @storybook/test-runner @storybook/addon-coverage
...
pnpm install supabase @supabase/supabase-js @supabase/auth-helpers-nextjs
...
pnpm install -D jsdom @testing-library/react @testing-library/jest-dom
