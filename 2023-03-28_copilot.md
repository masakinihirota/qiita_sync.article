...
結論:**GitHub Copilot Chat** のアイコンをセカンダリサイドバーがある右側にドラッグアンドドロップします。
...
プライマリサイドバーに登録されるということです。

現在サイドバーは2種類あって、プライマリサイドバーとセカンダリサイドバーがあります。

**GitHub Copilot Chat** を表示する場所の選択肢は３つあります
