...
ただ、Copilot X の開発コンセプトが、**開発ライフサイクル全体を通してすぐに利用できるAIアシスタント**に進化させるべく取り組んでいます。とあるのでこれらの機能を統合したものをCopilot Xとして販売すると思われます。
...
* GitHub Copilot X 発表はされたがまだ詳細な報告されていない。 (2023年3月28日)
...
#### まとめて候補を出す
通常は１行に1つづつ、そしてショートカットキーで一つ一つ見ていくが、それをまとめて表示して欲しい時に使う。
