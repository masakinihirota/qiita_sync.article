...
より制度の良い提案をしてもらうためには必要なファイルを開いておくと良いでしょう。
逆に関係のないタブを開かないほうが良いでしょう。
...
(参考:トークン ChatGPTだと英文字4096 日本語だと3000文字ぐらい)
