...
| サイドバー開閉のトグル [（独自）](#VSCode キーボードショートカットキー)  | Ctrl+Shift+a |
...
このようにユーザーの任意の機能を独自に作成、追加することが出来ます。


# VSCode キーボードショートカットキー

左下の歯車アイコンをクリックして、設定を開きます。


## サイドバーの表示・非表示を切り替える
Github Copilot Labsの色々な機能を使うためには、サイドバーを表示する必要があります。
