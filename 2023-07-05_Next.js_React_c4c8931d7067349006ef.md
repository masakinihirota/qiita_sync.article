...
|	(New)[app-dir-i18n-routing](https://github.com/vercel/next.js/tree/canary/examples/app-dir-i18n-routing "app-dir-i18n-routing") 	|	Next.jsは、アプリディレクトリ内での国際化ルーティングをデフォルトでサポートしていませんが、自分で簡単に実装することができます。この例では、Edge上で国際化ルーティングを実装する方法を示しています。	|		|
