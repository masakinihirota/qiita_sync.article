...
指定したファイルを読み込ませると、そのファイルの内容を元にして質問に答えてくれたり、コードを生成してくれるようになります。

開いているファイルならば、GitHub Copilot chat inline機能で実現できます。
しかし、GitHub Copilot chat inline機能の場合、長すぎるファイルの場合、途中で処理が止まってしまう事があります。
GitHub Copilot には指定フォルダ全体を読み込ませる機能はありません。
