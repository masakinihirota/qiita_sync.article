...
# SupabaseのExtention一覧

合計69個のExtentionがあります。

これらを利用するには、Supabaseのダッシュボードから
左サイドバーのDatabaseをクリックして、Extentionをクリックします。


<details><summary>SupabaseのExtention一覧</summary>
