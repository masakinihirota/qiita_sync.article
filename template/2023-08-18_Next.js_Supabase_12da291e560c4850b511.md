...
認証済みの状態で、さらに認証画面を開けてしまう。
認証状態をチェックしてTOPページなりに遷移させる必要がある。
middleware.tsx
...
https://github.com/masakinihirota/vns_template

↑このテンプレートのリポジトリにGitHub Actionを追加してみます。
